...
def disciplina(disciplinas,numero,turmas):
    ...
    if len(disciplinas_desejadas) > 0:
        retornado.append(f"Turmas com pelo menos {numero} docentes:")
        for chave in disciplinas_desejadas:
            ...
            if len(turmas_f) > 0:
                ...
                retornado.append(string)
    else:
        retornado.append(f"No hay {numero}...")
    return retornado
...
while True:
    ...
    # executa o disciplina
        ...
        lista = disciplina(dic_disciplina,num_docentes,turmas)
        if len(lista) == 1:
            print(f"No hay {num_docentes}...")
        else:
            for coisa in lista:
                print(coisa)
